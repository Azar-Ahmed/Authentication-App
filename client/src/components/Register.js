            ...
            <div className={styles.glass} style={{width:'40%'}}>
              ...
              <form className='py-1' onSubmit={formik.handleSubmit}>
                ...
                <div className='textbox flex flex-col items-center gap-6'>
                  ...
                  <input type='email' {...formik.getFieldProps('email')} className={styles.textbox} placeholder='Email Address' />
                  <input type='password' {...formik.getFieldProps('password')} className={styles.textbox} placeholder='Password' />
                  <button type='submit' className={styles.btn}>Register</button>
                </div>
                <div className='text-center py-4'>
                    <span className='text-grey-500'>Already Registered? <Link to='/' className='text-red-500'>Login Now</Link> </span>
                </div>
              </form>
